...
- Enkelvoudige sleutels: elke kolom die in `Bestandsbeschrijving_Dec-bestanden_*.txt`
  vermeld staat wordt vergeleken met de eerste kolom van het bijbehorende DEC-bestand.
- Samengestelde sleutels: kolomcombinaties (bijv. Instellingscode + Vestigingsnummer)
  worden als paar gevalideerd tegen de eerste twee kolommen van het DEC-bestand.
